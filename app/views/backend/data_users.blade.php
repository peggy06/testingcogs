                        ...
                        <?php endif ?>
                            	...
                            	<?php if($class=="new"): ?>
                                    <form action="/usersave" class="form-horizontal form-label-left input_mask" method="post" >
                                       ...
                                       <div id="gender" >
						  					<input type="radio" name="type" value="2" <?php echo (isset($type))?(($type==2)?"checked":""):""; ?>  /> &nbsp; Admin &nbsp;
						  					<input type="radio" name="type" value="3" <?php echo (isset($type))?(($type==3)?"checked":""):""; ?> /> &nbsp; Staff &nbsp;
						  			</div>
