                            ...
                            <div class="x_panel" style="height:600px;">
                                ...
                                <form action="<?php echo ($type=='user')? "/REdashboard" : "/REdashboardadmin" ?>" method="post">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <?php foreach($order as $userorder): ?>
                                            <tr>
                                                <th scope="row"><?php echo $userorder->order_id; ?></th>
                                                <td></td>
                                                <td><?php echo $userorder->total_amoun; ?></td>
                                                <td><?php echo $userorder->order_date; ?></td>
                                                <td><?php echo $userorder->status; ?></td>
                                                <td><a>View</a> | <a>Dispose</a></td>
                                            </tr>
                                         <?php endforeach;?>
                                        </tbody>
                                    </table><br>
